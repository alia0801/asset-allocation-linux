...
unset($out);
exec("/usr/bin/python3 functions/再平衡_risk_日.py {$sqlyourname1} {$sqlpassword1}",$out,$ret);
$date_arr = implode(",",explode(" ",$out[0]));
...
unset($out);
exec("/usr/bin/python3 functions/db_get.py {$sqlyourname1} {$sqlpassword1}",$out,$ret);
$flame_1 = $out[0];
$flame_2 = $out[1];
$flame_4 = $risk_d[0];
